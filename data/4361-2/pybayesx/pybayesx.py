...
class BayesX:
    ...
    def set_priors(self, **kwargs: Prior) -> None:
        ...
        priors["m200_prior"] = Prior("m200_prior", 1, 1e14, 1e15)
        ...
        priors["z_Prior"] = Prior("z_Prior", 0, 0.164, 0.164)
    ...
    def bin_and_export(self, n_bins: int, cellsize: float, **kwargs):
        ...
        # self.config["xrayNch"] = int(evts.size / n_bins / n_bins)
        # print(self.config["xrayNch"])
